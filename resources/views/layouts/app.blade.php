...
<head>
    ...
    <!-- CSS -->
    <link rel="stylesheet" href="{{ asset('css/UtilisateurCSS.css') }}">
...
<body>
    <div id="app">
        <nav class="navbar navbar-expand-md navbar-light bg-white shadow-sm">
            <div class="container">
                <a class="navbar-brand" href="{{ route('connecte.simple') }}">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('places.index') }}">Réserver un Lieu</a>
                    </li>
                    </ul>
